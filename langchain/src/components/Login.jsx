        ...
        axios.post('http://localhost:3001/login', { email, password })
            .then(result => {
                ...
                if (result.data === "Success") {
                    ...
                    setError(result.data); // Display error message to the user
                }
            })
            .catch(err => {
                console.error(err);
            ...
            <div className='bg-white p-3 rounded w-25'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='mb-3'>
                        ...
                        <input type="password" placeholder='Enter Password' autoComplete='off' name='password' className='form-control rounded-0' value={password} onChange={(e) => setPassword(e.target.value)} />
                    </div>
